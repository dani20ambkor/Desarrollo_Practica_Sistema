 ...
 */
public class AutosViaje1 extends javax.swing.JFrame {
    ...
    public void cargarTablaAutos(String Dato) {
        ...
        Connection cn = cc.conectar();
        String sql = "";
        sql = "select * from autos where ESTADO=" + 0 + " AND AUT_PLACA LIKE'%" + Dato + "%'"; //Para hacer un select en la base de datos
    ...
    public void borrar() {
        ...
        Connection cn = cc.conectar();
        String sql = "";
        sql = "update autos set ESTADO ='" + 1 + "' where AUT_PLACA ='" + txt_Placa.getText() + "'";
        try {
    ...
    public void guardar() {
        ...
        if (txt_Placa.getText().isEmpty()) {
            ...
            String sql = "";
            sql = "insert into autos(AUT_PLACA, AUT_MARCA, AUT_MODELO, AUT_COLOR, AUT_ANIO, AUT_DESCRIPCION, ESTADO)"
                    + "values(?,?,?,?,?,?,?)";
            try {
                PreparedStatement psd = cn.prepareStatement(sql);
                ...
                Logger.getLogger(AutosViaje1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void actualizar() {
        ...
        String sql4 = "";
        String sql5 = "";
        sql = "update autos set AUT_MARCA ='" + txt_Marca.getText() + "' where AUT_PLACA ='" + txt_Placa.getText() + "'";
        sql2 = "update autos set AUT_MODELO ='" + txt_Modelo.getText() + "' where AUT_PLACA ='" + txt_Placa.getText() + "'";
        sql3 = "update autos set AUT_COLOR ='" + txt_Color.getText() + "' where AUT_PLACA ='" + txt_Placa.getText() + "'";
        sql4 = "update autos set AUT_ANIO ='" + jy_Anio_Auto.getYear() + "' where AUT_PLACA ='" + txt_Placa.getText() + "'";
        sql5 = "update autos set AUT_DESCRIPCION ='" + txt_Descripcion.getText() + "' where AUT_PLACA ='" + txt_Placa.getText() + "'";
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addComponent(txt_Modelo, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AutosViaje1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new AutosViaje1().setVisible(true);
            }
        });
    }
